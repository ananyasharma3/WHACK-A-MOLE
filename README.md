# WHACK-A-MOLE
Developed a fun and interactive Whack-A-Mole game using Python. The game challenges players to whack moles that appear randomly on the screen within a limited time. This project demonstrates the use of Python for building graphical user interface applications and introduces basic concepts of event handling, game loops, and animation.
# Installation
To run the Whack-A-Mole game on your local machine, follow these steps: # Clone the repository: git clone https://github.com/ananyasharma3/whack-a-mole-python.git # Navigate to the project directory: cd whack-a-mole-python # Install the required dependencies: Make sure you have pip installed. Then run: pip install -r requirements.txt # Run the game: python pythonproject.py
# How to play this 
