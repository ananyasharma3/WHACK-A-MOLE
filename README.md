...
#Clone the repository: git clone https://github.com/ananyasharma3/whack-a-mole-python.git 
#Navigate to the project directory: cd whack-a-mole-python 
#Install the required dependencies: Make sure you have pip installed. Then run: pip install -r requirements.txt 
#Run the game: python pythonproject.py
# How to play this 
